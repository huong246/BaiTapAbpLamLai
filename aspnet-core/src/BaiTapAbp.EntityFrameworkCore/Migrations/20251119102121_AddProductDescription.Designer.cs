...
namespace BaiTapAbp.Migrations
{
    ...
    [Migration("20251119102121_AddProductDescription")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaiTapAbp.Entities.CartEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CustomerId", "ShopId", "ProductId")
                        .IsUnique();

                    b.ToTable("Cart", (string)null);
                });

            modelBuilder.Entity("BaiTapAbp.Entities.CategoryEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BaiTapAbp.Entities.ProductEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BaiTapAbp.Entities.ProductImageEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BaiTapAbp.Entities.SellerRequestEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SellerRequest");
                });

            modelBuilder.Entity("BaiTapAbp.Entities.ShopEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BaiTapAbp.Entities.ProductEntity", b =>
                {
                    b.HasOne("BaiTapAbp.Entities.CategoryEntity", null)
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BaiTapAbp.Entities.ShopEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BaiTapAbp.Entities.ShopEntity", b =>
                {
                    b.HasOne("BaiTapAbp.Entities.UserEntity", null)
                        .WithOne()
                        .HasForeignKey("BaiTapAbp.Entities.ShopEntity", "SellerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
